...
ray start --head --node-ip-address ${MASTER_ADDR} --num-gpus 4 --disable-usage-stats --dashboard-host=0.0.0.0 --dashboard-port=${DASH_PORT} --dashboard-agent-listen-port=${AGENT_PORT}
